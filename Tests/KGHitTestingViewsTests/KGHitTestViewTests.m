...
@interface KGHitTestViewTests : KGHitTestBaseTest

@end

@implementation KGHitTestViewTests

- (void)setUp {
    [super setUp];
    // Put setup code here. This method is called before the invocation of each test method in the class.
    self.hitTestObject = [[KGHitTestingView alloc] initWithFrame:CGRectMake(0, 0, kWidth, kHeight)];
}
